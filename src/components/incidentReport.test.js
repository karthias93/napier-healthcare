...
const customRender = async (ui, { providerProps, irProviderProps, renderState, ...renderOptions }) => {
...
describe("Incident Report Form", () => {
  ...
  test('file upload', async () => {
    ...
    const fileInput = screen.getByTestId('fileInput').querySelector(`input[type='file']`);
    await waitFor(() =>
...
describe("Different date format", () => {
  ...
  test("Location details validation", async () => {
    ...
    const locationDetailsEntry = document.querySelector(`input[name="locationDetailsEntry"]`);
    await act(async () => {
